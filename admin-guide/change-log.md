...
* **Deprecation notice:**  ****The legacy NodeJS SDK will no longer be actively supported in March 2022. At this date you will still be able to use the SDK, however, please consider our SDKs in Java, Python or .Net if you prefer to benefit from a better support.
