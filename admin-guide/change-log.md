...
The Swagger file for v20.12 available [here](https://github.com/symphonyoss/symphony-api-spec/tree/20.12).
...
To download the Agent, click [here](https://storage.googleapis.com/sym-platform/developers/rest-api/agent-20.12.3.zip).
