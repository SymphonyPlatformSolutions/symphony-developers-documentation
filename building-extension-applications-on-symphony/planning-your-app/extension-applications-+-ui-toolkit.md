...
{% hint style="info" %}
Note: If you don't have the `symphony-bdk-cli` installed, continue to the [cli-tool](../../developer-tools/developer-tools/bdk-2.0-java/bdk-1.0-java/cli-tool.md) guide.
{% endhint %}
