...
{% api-method method="post" host="https://<host>:<port>" path="/login/v1/pubkey/app/authenticate/extensionApp" %}
{% api-method-summary %}
...
{% api-method-parameter name="authToken" type="string" required=false %}
