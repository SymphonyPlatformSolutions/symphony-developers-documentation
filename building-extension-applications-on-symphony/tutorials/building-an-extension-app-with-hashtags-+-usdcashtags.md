...
In this tutorial we will be building off the generated app + bot scaffolds provided by the BDK 1.0. The BDK comes out of the box with a number of best practices as well as boiler plate code in order to streamline extension app development. The following demonstrates the BDK's implementation for bootstrapping your extension app:
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:left"><code>cashtag</code>
      </td>
