...
{% hint style="info" %}
Many of these event handlers are provided out of the box by the BDK 1.0 App Template. To learn more about the out-of-the-box implementations provided by the BDK 1.0, continue to the [Planning Your App](../planning-your-app/) or [Tutorials](./) sections.
{% endhint %}
