...
* [Getting Started](bots/getting-started/README.md)
  ...
  * [Getting Started with WDK](bots/getting-started/wdk.md)
...
* [Tutorials](ext-apps/tutorials/README.md)
  * [Building an Extension App with UI Buttons](ext-apps/tutorials/building-an-extension-app-with-ui-buttons.md)
  * [Building an Extension App with #hashtags & $cashtags](ext-apps/tutorials/building-an-extension-app-with-hashtags-+-usdcashtags.md)
  * [Building an Extension App with Structured Objects](ext-apps/tutorials/building-an-extension-app-with-structured-objects.md)
  * [Building an Extension App with UI Toolkit](ext-apps/tutorials/building-an-extension-app-with-ui-toolkit.md)
...
* [App Configuration](ext-apps/app-configuration/README.md)
  * [Configure your App for BDK 1.0 Development](ext-apps/app-configuration/configure-your-app-for-bdk-development.md)
  * [Updating User Apps](ext-apps/app-configuration/updating-user-apps-1.md)
  * [Application Manifest Bundle File Reference](ext-apps/app-configuration/application-manifest-bundle-file-reference.md)
...
* [Bot Developer Kit for Java](dev-tools/bdk-java/README.md)
  * [Building a Conversational Bot](dev-tools/bdk-java/conversational.md)
  * [Building an Interactive Bot](dev-tools/bdk-java/interactive.md)
  * [Building a Headless Bot](dev-tools/bdk-java/headless.md)
  * [Integrating a Bot with an Identity Provider](dev-tools/bdk-java/identity.md)
* [Bot Developer Kit for Python](dev-tools/bdk-python.md)
* [Workflow Developer Kit](dev-tools/wdk.md)
...
* [Symphony URI](embedded-modules/symphony-uri/README.md)
...
* [Desktop interoperability](embedded-modules/desktop-interoperability/README.md)
  ...
  * [Support for Embedded Collaboration Platform](embedded-modules/desktop-interoperability/support-for-embedded-collaboration-platform.md)
  * [Change log](embedded-modules/desktop-interoperability/change-log.md)
* [Embedded Collaboration Platform](embedded-modules/embedded-collaboration-platform/README.md)
  * [Get started](embedded-modules/embedded-collaboration-platform/get-started.md)
  * [Configuration parameters](embedded-modules/embedded-collaboration-platform/configuration-parameters.md)
  * [Open a chat](embedded-modules/embedded-collaboration-platform/open-a-chat.md)
  * [Send a message](embedded-modules/embedded-collaboration-platform/send-a-message.md)
  * [Create a room](embedded-modules/embedded-collaboration-platform/create-a-room.md)
  * [Pin a message](embedded-modules/embedded-collaboration-platform/pin-a-message.md)
  ...
  * [ECP Design and UX](embedded-modules/embedded-collaboration-platform/ecp-design-and-ux/README.md)
    * [Onboarding](embedded-modules/embedded-collaboration-platform/ecp-design-and-ux/onboarding.md)
    * [Accessibility](embedded-modules/embedded-collaboration-platform/ecp-design-and-ux/accessibility.md)
    * [Error messages](embedded-modules/embedded-collaboration-platform/ecp-design-and-ux/error-messages.md)
...
* [Change Logs](admin-guide/change-log/README.md)
  * [Agent](admin-guide/change-log/agent/README.md)
    * [Agent - 23.7.1](admin-guide/change-log/agent/agent-23.7.1.md)
    ...
    * [Agent - 22.12 (LTS)](admin-guide/change-log/agent/agent-22.12-lts.md)
    ...
    * [Archives](admin-guide/change-log/agent/archives/README.md)
      ...
      * [Agent - 20.14](admin-guide/change-log/agent/archives/agent-20.14.md)
      * [Agent - 20.13](admin-guide/change-log/agent/archives/agent-20.13.md)
      * [Agent - 20.12](admin-guide/change-log/agent/archives/agent-20.12.md)
  ...
  * [SBE API endpoints (pod)](admin-guide/change-log/sbe-api-endpoints-pod/README.md)
    * [SBE - 20.16 - DRAFT](admin-guide/change-log/sbe-api-endpoints-pod/sbe-20.16-draft.md)
    * [SBE - 20.15](admin-guide/change-log/sbe-api-endpoints-pod/sbe-20.15.md)
    * [SBE - 20.14](admin-guide/change-log/sbe-api-endpoints-pod/sbe-20.14.md)
  ...
  * [Client 2.0 extensibility updates](admin-guide/change-log/client-2.0-extensibility-updates/README.md)
    * [Client 2.0 - 23.02 Draft](admin-guide/change-log/client-2.0-extensibility-updates/client-2.0-23.02-draft.md)
    * [Client 2.0 - 22.11](admin-guide/change-log/client-2.0-extensibility-updates/client-2.0-22.11.md)
    * [Client 2.0 - 22.10](admin-guide/change-log/client-2.0-extensibility-updates/client-2.0-22.10.md)
