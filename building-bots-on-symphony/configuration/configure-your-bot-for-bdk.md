...
Now that you have generated and configured your Bot, move onto one our guides on [Building a Chatbot using BDK](https://github.com/SymphonyPlatformSolutions/symphony-developers-documentation/tree/b799acad1e4d419ec358e2c745b89c5484b16e65/building-bots-on-symphony/planning-your-bot/chatbot/getting-started-with-chatbots/building-a-chatbot-using-bdk.md), [Building an Interactive Bot using BDK](../planning-your-bot/interactive-bot/getting-started/building-an-interactive-bot-using-bdk.md), or [Building a Headless Bot using the BDK](../planning-your-bot/headless-bot/getting-started/building-a-headless-bot-using-the-bdk.md).
