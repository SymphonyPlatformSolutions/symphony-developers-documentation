...
<table data-header-hidden><thead><tr><th width="167.33333333333331">Parameters</th><th width="130">Type</th><th>Description</th></tr></thead><tbody><tr><td>Parameters</td><td>Type</td><td>Description</td></tr><tr><td>id</td><td>String</td><td>The id of the module for which the title should be changed</td></tr><tr><td><strong>Either</strong> <code>title</code> <strong>or</strong> <code>{title, icon}</code></td><td>String or Object</td><td><p><strong>Either</strong> the title of the module as a string<br><strong>or</strong> an object with the keys <code>title</code> and <code>icon</code> :</p><ul><li><code>title</code> module name as a string </li><li><code>icon</code> is either the url of a square SVG image (recommended), or the url of a 32x16 pixel sprite sheet: the first 16x16 pixels will be used in a dark theme, and second will be used in the light theme.</li></ul></td></tr></tbody></table>
