...
{% hint style="info" %}
Note: Each extension app will contain a unique app id that is registered on the Pod. You can learn more about this along with other setup prerequisites in the [App Configuration](/broken/pages/-MJPWunOtW6o05p-lHKP) section.
{% endhint %}
...
| --------- | ------ | -------------------------------------------------------------------------------------------------- |
| appToken  | string | Token generated by the application.                                                                |
| authToken | string | A JWT containing the caller's username and an expiration date, signed by the caller's private key. |
...
{% content-ref url="/broken/pages/-MJPWunPzCt7WsNwlH3u" %}
[Broken link](/broken/pages/-MJPWunPzCt7WsNwlH3u)
{% endcontent-ref %}
