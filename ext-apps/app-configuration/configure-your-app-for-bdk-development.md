...
{% hint style="info" %}
For this guide we will be building on top of the BDK 1.0.  The reason we are not using BDK 2.0 for this guide, is because BDK 1.0 bot backend integrates seamlessly with the app template or frontend that is generated by the [`symphony-bdk-cli`](broken-reference) tool.  From the `symphony-bdk-cl`i tool, you can easily generate your app frontend and your app backend (otherwise known as a Symphony Bot). &#x20;
...
![](<../../.gitbook/assets/Screen Shot 2020-08-25 at 11.58.02 PM.png>)
